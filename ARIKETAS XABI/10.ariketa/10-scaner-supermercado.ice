    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 10: Escáner de supermercado. Contando los artículos comprados\n\nJarraian daukagun ariketan sensore infrarojo bat daukagu, elementu bat pasatzen den momentuan, soinu bat egingo du eta salidako tick baten ondorioz, LED bat piztuko dugu. \nBaita ere, puerta logika AND bat daukagu, bere sarrerak pitidotik eta \"corazon generico para bonbear los bits(frekuentzia)\"-etik datozte. Beste aldetik, \nsoinuko irteeratik kontadore batera iristen da seinalea eta honek DISPLAY batera bidaliko du seinalea, hor ikusiko dugu zenbat objetu pasatzen diren sensoretik. \nAzkenik, pulsadore bat daukagu kontadorea reseteatu ahal izateko.\n",
            "readonly": false
          },
          "position": {
            "x": 64,
