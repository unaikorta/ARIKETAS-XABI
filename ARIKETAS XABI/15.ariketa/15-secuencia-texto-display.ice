    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Ejemplo 15: Secuencia de texto en display de 7 segmentos\n\nVamos a utilizar el display de 7 segmentos para sacar el texto HOLA, de forma que los caracteres vayan apareciendo secuencialmente. \nEl circuito es similar al ejemplo anterior, pero cambiando el contenio de la mememoria y el tamaño del contador y la tabla.\nAñadimos un interruptor para mostrar el texto a dos velocidades: Lenta y rápida",
            "readonly": false
          },
          "position": {
            "x": -120,
